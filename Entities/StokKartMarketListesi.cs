...
public partial class StokKartMarketListesi
{
    ...
    public string? UretimYerAd { get; set; }
    ...
    public string? OzelKod1Ad { get; set; }

    public string? OzelKod2Ad { get; set; }

    public string? BagliCariKod { get; set; }

    public string? BagliCariUnvan { get; set; }
    ...
    public double Alsiadesiztopmik { get; set; }

    public double Satiadesiztopmik { get; set; }

    public double? Alsiadesiztoptut { get; set; }

    public double? Satiadesiztoptut { get; set; }

    public double Agirorttoptut { get; set; }
    ...
    public double? Sat3fiykdvli { get; set; }

    public double? Sat3fiykdvsiz { get; set; }

    public double? Sat4fiykdvli { get; set; }

    public double? Sat4fiykdvsiz { get; set; }
    ...
    public double Alstopmik { get; set; }

    public double Kaltopmik { get; set; }
