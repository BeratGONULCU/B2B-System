...
public partial class Bankahrk
{
    public decimal Id { get; set; }

    public string Bankod { get; set; } = null!;

    public double Bankhrkid { get; set; }
    ...
    public string? Karsihestip { get; set; }
    ...
    public double? FaizOran { get; set; }

    public double? FaizTutar { get; set; }

    public DateTime? TaksitBasTar { get; set; }

    public int? TaksitSay { get; set; }

    public DateTime? TaksitBitTar { get; set; }
    ...
    public int? TopluKayitHrkId { get; set; }
}
